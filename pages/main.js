  ...
  return (
    <div className='min-h-screen bg-gray-100'>
      <main className="container mx-auto px-4 py-8 md:py-16 lg:py-20">
        <div className="flex flex-col md:flex-row">
          ...
          className="md:w-1/2 md:pr-8 order-1 md:order-2">
            ...
            >
              ...
              <h3 className="text-2xl md:text-3xl font-semibold mb-4">I&apos;m Song Joo, your future colleague 😊</h3>
        ...
        className="flex flex-col items-center justify-center w-4/5 md:mt-6 mx-auto"
        >
